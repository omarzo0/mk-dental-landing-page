/**
 * Admin Forgot Password API Route
...
export async function POST(request: NextRequest) {
    try {
        ...
        const apiUrl = `${API_BASE_URL}/api/admin/auth/forgot-password`;
        console.log("[Admin Forgot Password Proxy] Forwarding request to:", apiUrl);
        ...
        console.error("[Admin Forgot Password Proxy] Error:", error);
